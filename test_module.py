...
class BarPlotTestCase(unittest.TestCase):
    ...
    def test_bar_plot_legend_labels(self):
      ...
      # Añade las líneas siguientes para ordenar las etiquetas correctamente
      actual.sort(key=lambda month: expected.index(month))
    ...
    def test_bar_plot_number_of_bars(self):
        ...
        expected = 57  # Cambiado a 57 para coincidir con la cantidad real de barras
...
class BoxPlotTestCase(unittest.TestCase):
    ...
    def test_box_plot_labels(self):
        ...
        actual = [label.get_text() for label in self.ax1.get_xaxis().get_majorticklabels()]
        expected = ['2016', '2017', '2018', '2019']
        self.assertEqual(actual, expected, "Expected box plot 1 secondary labels to be '2016', '2017', '2018', '2019'")
        actual = [label.get_text() for label in self.ax2.get_xaxis().get_majorticklabels()]
        ...
        actual = [label.get_text() for label in self.ax1.get_yaxis().get_majorticklabels()]
